  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div data-aos="fade-right" className="text-start px-10 mb-20">
        ...
        <div data-aos="fade-left" className="relative">
          <div className="grid grid-cols-1 px-10 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
            {processData.map((step, index) => (
              <div
                key={index}
                className="process-step group relative flex flex-col items-center text-center p-6 rounded-tl-[4rem] rounded-br-[4rem] border border-gray-700/30 transition-all duration-500 bg-white hover:shadow-xl overflow-hidden"
              >
                {/* SVG Background */}
                <div className="absolute inset-0 opacity-20 pointer-events-none translate-x-1/2">
                  <svg
                ...
                {/* Step Icon */}
                <div className="step-icon w-14 h-14 rounded-xl flex items-center justify-center mb-4 bg-gray-100 text-gray-700 border border-gray-400 relative z-10">
                  {step.icon}
                </div>
