...
//       <div className="container mx-auto px-6 md:py-24 py-8 grid xl:grid-cols-4 gap-8">
//         {/* LEFT: Recent Blogs - Professional Clean Layout */}
...
//                   <h3 className="font-medium text-gray-900 text-sm leading-snug mb-1 line-clamp-2 group-hover:text-blue-600 transition-colors">
//                     {blog.title}
//                   </h3>
...
//                 {/* Active Accent Bar */}
//                 {index === activeBlog && (
//                   <div className="absolute left-0 top-0 h-full w-[3px] bg-blue-500 rounded-l-lg"></div>
//                 )}
//               </div>
//             ))}
//           </div>
...
export default function HeroBlog() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 md:px-8 py-10 grid xl:grid-cols-4 gap-8">
        {/* LEFT: Recent Blogs */}
        <div className="xl:col-span-1 flex flex-col">
          <h2 className="text-xl font-semibold mb-5 text-gray-800 border-b pb-2 text-center">
            Recent Blogs
        ...
        <div
          ref={sidebarRef}
          className="xl:col-span-1 space-y-8 sticky top-10 self-start"
        >
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">
              Popular Posts
